        ...
        <View style={tailwind.style(
            ...
            <View style={tailwind.style(
                ...
                <View style={tailwind.style("flex justify-center items-center")}>
                    <Text style={[
                        { fontFamily: "Dosis_700Bold" },
                        tailwind.style("text-[120px] text-[#000000]")
                    ]}>
                        77
                    </Text>
                    <Text style={[
                        { fontFamily: "Dosis_500Medium" },
                        tailwind.style("text-[20px] text-[#000000] mt-[-10px] font-normal ")
                    ]}>
                        Minutes Elapsed
                    </Text>
                </View>
            ...
            <View style={tailwind.style(
                ...
                <View style={tailwind.style(
                    ...
                    <View style={tailwind.style("flex flex-col w-[280px]")}>
                        <View style={tailwind.style("flex justify-center items-center bg-[#71AD46] rounded-lg w-[85px] h-[16px]")}>
                            <Text style={[
                                { fontFamily: "Dosis_400Regular" },
                                tailwind.style("text-[#FFFFFF] text-[12px]")
                            ]}>
                                FINALIZED
                            </Text>
                        </View>
                        <View style={tailwind.style("flex justify-start")}>
                            ...
                            <Text style={[
                                ...
                                tailwind.style("text-[#000000] text-[16px] font-semibold ")
                            ]}>
                ...
                <View style={tailwind.style(
                    ...
                    <Text style={[
                        { fontFamily: "Dosis_500Medium" },
                        tailwind.style("text-[#FFFFFF] text-[18px]")
                    ]}>
                        HIGH PRIORITY
                    </Text>
                </View>
            ...
            <View style={tailwind.style(
                ...
                <View style={tailwind.style(
                    ...
                    <View>
                        <Text style={[
                            { fontFamily: "Dosis_400Regular" },
                            tailwind.style("text-[#000000] text-[16px] font-light")
                        ]}>
                            02/02/2023 17:25
                        </Text>
                        <Text style={[
            ...
            <View style={tailwind.style(
                ...
                <View style={tailwind.style(
                    ...
                    <View>
                        <Text style={[
                            { fontFamily: "Dosis_400Regular" },
                            tailwind.style("text-[#000000] text-[16px]")
                        ]}>
                            02/02/2023 17:25
                        </Text>
                        <Text style={[
